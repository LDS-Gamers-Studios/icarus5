...
module.exports = {
   ...
   * @returns {Promise<infraction>} The deleted infraction
   */
  remove: async function(flag) {
    if (flag.id) flag = flag.id;
    return await Infraction.findOneAndDelete({ flag }).exec();
  },

  /**
   * Save an infraction
   * @param {infraction} data Data to save
   * @returns {infraction} The saved infraction
   */
  save: function(data) {
